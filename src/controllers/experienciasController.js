...
exports.createExperiencia = async (req, res) => {
    ...
    const novaExperiencia = await experienciasRepository.createExperiencia(experiencia);
...
exports.updateExperiencia = async (req, res) => {
    const id = parseInt(req.params.id);
    const experiencia = req.body;
    const experienciaAtualizada = await experienciasRepository.updateExperiencia(id, experiencia);
